...
2. **Build your app**:
   ...
   - Option B: Have a custom model you want to showcase? You can upload your model to [Mélange](https://mlange.zetic.ai), convert it for on-device inference, and generate production-ready code automatically. Or [join our Discord](https://discord.com/invite/gVFX6myuMx) and let us know, we'd love to help you get it running.
