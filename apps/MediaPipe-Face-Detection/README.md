...
**Ultra-Fast Face Detection for Mobile Devices**
...
> [!TIP]
> **View on MLange Dashboard**: [google/MediaPipe-Face-Detection](https://mlange.zetic.ai/p/google/MediaPipe-Face-Detection?from=use-cases) - Contains generated source code & benchmark reports.
...
- **MLange Dashboard**: [View Model & Reports](https://mlange.zetic.ai/p/google/MediaPipe-Face-Detection?from=use-cases)
...
- **Task**: Face Detection
- **MLange Project**: [google/MediaPipe-Face-Detection](https://mlange.zetic.ai/p/google/MediaPipe-Face-Detection?from=use-cases)
- **Key Features**:
